...
role:
  ...
  mandatory_workflow:
    step_1_todo_list: |
      ...
      1. ✓ Этап 0: Google поиск - запрос '[ЗАПРОС]', проверка 2 страниц результатов
      2. ⏳ Этап 1: Прямые источники приоритета 1 - vseinstrumenti.ru, komus.ru, etm.ru, petrovich.ru...
      3. ⏳ Этап 2: Яндекс.Маркет (если нужно)
